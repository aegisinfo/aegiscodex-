...
export const CommandSuggestions = ({ input, cursorPosition, onSelectSuggestion, visible, }) => {
    ...
    return (_jsxs(Box, { flexDirection: "column", marginLeft: 1, marginBottom: 0, borderStyle: "round", borderColor: theme.colors.border.light, paddingX: 1, paddingY: 0, children: [_jsxs(Text, { dimColor: true, children: ["Commands (", suggestions.length, "):"] }), suggestions.map((s, i) => {
                ...
                return (_jsx(Box, { flexDirection: "row", children: _jsxs(Text, { children: [isSelected ? (_jsx(Text, { color: theme.colors.primary, bold: true, children: '>' })) : (_jsx(Text, { children: " " })), ' ', _jsx(Text, { color: isSelected ? theme.colors.primary : undefined, bold: isSelected, children: s.command }), _jsxs(Text, { color: theme.colors.text.muted, children: [" \u2014 ", s.description] })] }) }, s.command));
