...
export type HookInput = PreToolUseInput | PostToolUseInput | PostToolUseFailureInput | PermissionRequestInput | UserPromptSubmitInput | SessionStartInput | SessionEndInput | StopInput | SubagentStopInput | NotificationInput | CompactionInput;
/**
 * PreToolUse 输出
 */
...
export type HookSpecificOutput = PreToolUseOutput | PostToolUseOutput | PermissionRequestOutput | StopOutput | CompactionOutput;
/**
 * Hook 执行上下文
 */
