...
/** FocusId 常量枚举 */
export declare const FocusId: {
    readonly MAIN_INPUT: FocusId;
    readonly MESSAGES: FocusId;
    readonly CONFIRMATION_PROMPT: FocusId;
    readonly THEME_SELECTOR: FocusId;
    readonly SELECTOR: FocusId;
    readonly MODAL: FocusId;
    readonly NONE: FocusId;
};
