...
export function classifyComplexity(message) {
    ...
    const mentionsManyFiles = (text.match(/\b[\w./-]+\.(ts|tsx|js|jsx|py|go|rs|java|json|md)\b/gi) || []).length > 2;
 ...
 */
export function resolveModelForTier(tier, models, explicitTiers) {
    const usable = (id) => id ? models.find(m => m.id === id && m.apiKey) : undefined;
